...
<div class="login_container" >
  <div class="ibg-bg index-bg" id="bg" style="background: url(Images/bg2.jpg) no-repeat center center;transform: matrix(1,0,0,1,0,0); transition:all 500ms liner;">
	</div>
  <div class="header">
  	 <div class="logo">
		...
		<div class="B1">
	  	<form action="<%=path %>/Users/User_register" method="post">
	  		...
	  		<a style="display:block">
	  		 ...
	  		 <input  class="login_Input" id="password" type="hidden"  
	  		style="display:block">
	  		</a>
	  		<div id="message">
	  		</div>
